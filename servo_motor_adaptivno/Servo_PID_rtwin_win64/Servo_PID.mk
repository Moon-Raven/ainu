...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2013b/bin/win64/gmake"
HOST            = PC
BUILD           = yes
...
MODEL                := Servo_PID
MODULES              := Servo_PID_data.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Servo_PID.mk
MATLAB_ROOT          := C:/PROGRA~1/MATLAB/R2013b
MATLAB_BIN           := C:/PROGRA~1/MATLAB/R2013b/bin
S_FUNCTIONS          := Servo_Encoder.c servo_analoginputs.c Servo_PWM.c Servo_ResetEncoder.c Servo_BitstreamVersion.c Servo_PWMPrescaler.c Servo_PWMTherm.c Servo_ThermFlag.c
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 3
TID01EQ              := 1
...
RTWINDIR             := C:/PROGRA~1/MATLAB/R2013b/toolbox/rtw/targets/rtwin
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
#
MODELLIB                  := Servo_PIDlib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Servo_PID_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/Admin/Desktop/servo/Servo_PID_rtwin_win64;C:/Users/Admin/Desktop/servo;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
%.obj : $(MATLAB_ROOT)/toolbox/Servo/DevDriv/%.c $(MAKEFILE)
	$(call BUILDOBJ, $(CC))
...
%.obj : $(MATLAB_ROOT)/toolbox/Servo/DevDriv/%.cpp $(MAKEFILE)
	$(call BUILDOBJ, $(CPP))
